<?php
    session_start();
    require_once 'D:\OpenserverFolder\OSPanel\domains\RSFilms\config\connectionDB.php';
    $name = $_POST['name'];
    $text = $_POST['text'];
    ...
    if ( $_FILES['user_file']['error'] == UPLOAD_ERR_OK ) {
        do {
            ...
            $path = 'D:/OpenserverFolder/OSPanel/domains/RSFilms/assets/uploads/'.$rndName.$namePoster;
